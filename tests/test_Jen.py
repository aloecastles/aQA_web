...
class test1(unittest.TestCase):
    ...
    def test_test1(self):
        ...
        # wd.find_element(By.CSS_SELECTOR, "#cdk-overlay-1 > vd-login-rightdrawer > div > div > vd-login-rightdrawer-form > vd-tabs > section > div > vd-login-contract-form > div > form > vd-form-field:nth-child(1) > div > div.vd-form-field__field-wrap > input").send_keys("XXX")
        # # login page "Password" field type in
        # wd.find_element(By.CLASS_NAME, "login-input_password").send_keys("XXX")
