...
class test1(unittest.TestCase):
    ...
    def test_test1(self):
        ...
        self.searchOpen()
        self.searchQuery(Query="суперсила")
        self.firstSearchResultOpen()
        self.VODassetPageBigPlayClick()
        self.loginPagePA_Click()
        self.loginPagePA_emailFieldType(Group(FTTBlogin="demo_autotest"))
        self.loginPagePA_passwordType(FTTBpassword="123456")
        self.loginPagePA_loginBittonClick()
        self.VODplayerVolumeOff()
        self.VODplayerPauseClick()
        time.sleep(5)
